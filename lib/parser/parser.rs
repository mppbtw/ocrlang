...
impl<'a> Parser<'a> {
    ...
    /// Might error in the rare case that the lexer is unable to continue in the first 2 tokens,
    /// for example an integer that's too big or invalid string literal
